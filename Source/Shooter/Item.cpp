...
void AItem::FinishInterping()
{
	...
	if (Character)
	{
		// Subtract 1 from the item count of the interp location sturct
...
void AItem::InitialiseCustomDepth()
{
	DisableCustomDepth();
}
...
void AItem::Tick(float DeltaTime)
{
	...
	// Handle item interping when in the equip interping state
...
void AItem::StartItemCurve(AShooterCharacter* Char)
{
	...
	// Get array index in interp location with the lowest item count
